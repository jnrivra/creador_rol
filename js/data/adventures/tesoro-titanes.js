// Aventura 1: "La Búsqueda del Tesoro de los Titanes"
// Migrado desde scenes.js - auto-registrado en el registry
window.Carrera = window.Carrera || {};

(function() {
    var adventure = {
        id: 'tesoro-titanes',
        titulo: 'La Búsqueda del Tesoro de los Titanes',
        emoji: '💎',
        descripcion: 'Encuentra el legendario tesoro escondido por los Titanes en el Bosque de Bristley',
        dificultad: 1,
        nivelRecomendado: 1,
        duracion: '30-45 min',
        totalEscenas: 5,
    ...
    // Backward compatibility: also set window.Carrera.scenes
